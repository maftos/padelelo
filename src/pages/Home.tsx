...
const Home = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-8 px-4 space-y-24">
        <div className="max-w-7xl mx-auto animate-fade-in">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 mb-24">
            <Card className="p-6 space-y-4 hover:shadow-lg transition-shadow bg-accent/50 backdrop-blur border-accent">
          ...
          <section className="mb-24">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="p-8 bg-accent/50 backdrop-blur border-accent">
          ...
          <section className="mb-24">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6 bg-accent/50 backdrop-blur border-accent">
      ...
      {/* Footer */}
      <footer className="border-t border-accent mt-24">
